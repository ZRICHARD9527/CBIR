...
public class AHashMatch {
    static String baseUrl = "http://localhost:8181/user/ahashMatch";

    public static ArrayList<String> aHashMatch(String hash, int catchNum) {
    ...
    public static void main(String[] args) {
        String hash="";
        ArrayList<String> test = aHashMatch(hash, 12);
