...
public class MixMatch {
    ...
    static String baseUrl = "http://localhost:8181/user/mixMatch";

    public static ArrayList<String> getMatchPath(double[] color, double[] texture, double[] shape, double[] weight, int catchNum) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> test = getMatchPath(color, texture, shape, d, 14);
