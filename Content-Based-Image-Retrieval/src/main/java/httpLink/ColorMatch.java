...
/**
 * @Author: Z.Richard
 * @CreateTime: 2022/5/15 1:54
 * @Description:
 **/

public class ColorMatch {
    static String baseUrl = "http://localhost:8181/user/colorMatch";

    public static ArrayList<String> colorMatch(double[] color, int catchNum) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> test = colorMatch(color, 12);
