...
/**
 * @Author: Z.Richard
 * @CreateTime: 2022/5/15 2:01
 * @Description:
 **/

public class TextureMatch {
    static String baseUrl = "http://localhost:8181/user/textureMatch";

    public static ArrayList<String> textureMatch(double[] texture, int catchNum) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> test = textureMatch(texture, 12);
